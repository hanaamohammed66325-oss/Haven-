...
const FAQ: { q: string; a: string }[] = [
  {
    ...
    a: "لا توجد نسبة واحدة لكل الجامعات: تحدد كل جامعة نسبة الحرمان في لائحتها الدراسية. في أغلب الجامعات السعودية التي راجعنا لوائحها يكون الحرمان عند تجاوز ٢٥٪ من محاضرات المادة، وبعضها ٢٠٪ أو ١٥٪، وبعضها يضع حداً أقل للغياب بدون عذر. اختر نسبة جامعتك في الحاسبة أعلاه لتعرف عدد المحاضرات المسموح غيابها.",
  },
  {
  ...
  },
  {
    ...
    a: "لو المادة ٣ محاضرات أسبوعياً على ١٥ أسبوعاً = ٤٥ محاضرة، ونسبة الحرمان ٢٥٪، فالمسموح غيابه ١١ محاضرة كحد أقصى (١١ من ٤٥ = ٢٤٫٤٪)، والغياب الثاني عشر يتجاوز الحد. الحاسبة تحسبها لك بدقة.",
  },
  {
    q: "هل الغياب بعذر يحتسب؟",
    a: "نعم في الغالب: حسب اللائحة الموحدة للدراسة والاختبارات، الحرمان يُحسب على نسبة الحضور، والعذر المقبول يسمح لمجلس الكلية برفع الحرمان عنك — لا يحذف الغياب من النسبة. لذلك أدخل كل غياباتك في الحاسبة، ثم راجع لائحة جامعتك التنفيذية لأن التفاصيل تختلف بين الجامعات.",
  },
];
      ...
      <main className="mx-auto w-full max-w-[760px] px-5 flex-1 pb-16">
        ...
        <section className="mb-10">
          ...
          <p className="text-[15px] leading-relaxed mb-3" style={{ color: "var(--color-muted)" }}>
            ...
            نسبة غيابك = (غياباتك ÷ الإجمالي) × ١٠٠. إذا تجاوزت نسبتك حد الحرمان
            (تحدده لائحة جامعتك، وهو ٢٥٪ في أغلب الجامعات السعودية) تُحرم من دخول الاختبار النهائي للمادة؛ الوصول
            للحد بالضبط لا يُعدّ حرماناً، لكن أي غياب بعده يتجاوزه.
          </p>
          <p className="text-[15px] leading-relaxed" style={{ color: "var(--color-muted)" }}>
            ...
            يكون المسموح غيابه ١١ محاضرة كحد أقصى (٢٤٫٤٪).
          </p>
        </section>
