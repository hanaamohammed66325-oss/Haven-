...
const DESCRIPTION =
  "مخطط الفصل الدراسي مجاناً وبدون تسجيل — رتّب اختباراتك وكويزاتك وواجباتك ومواعيد التسليم على أسابيع الفصل، ويُحفظ في متصفّحك. من Haven.";
...
const FAQ: { q: string; a: string }[] = [
  {
    ...
    a: "اختر نوع العنصر (اختبار، كويز، واجب، تسليم، إجازة) ثم أضفه للأسبوع المناسب. يظهر لك مخطط كامل لأسابيع الفصل مع تمييز كل نوع بلون.",
  },
  {
    q: "هل يُحفظ مخططي؟",
    ...
    <div dir="rtl" lang="ar" className="min-h-dvh flex flex-col">
      ...
      <main className="mx-auto w-full max-w-[980px] px-5 flex-1 pb-16">
        ...
        <p className="text-[15px] leading-relaxed mb-7" style={{ color: "var(--color-muted)" }}>
          رتّب اختباراتك وكويزاتك وواجباتك ومواعيد التسليم على أسابيع الفصل —
