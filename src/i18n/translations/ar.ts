...
export const ar: Record<TranslationKey, string> = {
  ...
  pom_lakeLegend: "كل زهرة تمثّل مادة",
  pom_filterSubject: "اعرض:",
  pom_allSubjects: "الكل",
  pom_leafShape: "شكل الورقة لكل مادة",
  pom_customizePlant: "لون كل مادة",
  pom_color: "لون",
  pom_viewAuto: "تلقائي (حسب الساعة)",
  pom_viewDay: "نهار",
  pom_viewNight: "ليل",
  pom_leafClassic: "كلاسيكية",
  pom_leafRuffled: "مموّجة",
  pom_leafVictoria: "فيكتوريا",
  pom_leafLotus: "ورقة لوتس",
  pom_leafHeart: "قلب",
