...
export const ar: Record<TranslationKey, string> = {
  ...
  gam_badge_firstCheckin_why: "عادة التسجيل اليومي تكبر!",
  gam_badge_firstCheckin_howToGet: "سجّل حضورك {n} مرة من بطاقة الداشبورد",
  ...
  gam_badge_safe_howToGet: "ابقَ تحت حد الحرمان لمدة {n}+ أسابيع",

  gam_badge_organized: "المنظّم",
  gam_badge_organized_desc: "أنهِ {n} مهمة في المخطط",
  gam_badge_organized_why: "التخطيط والإنجاز يعكس الانضباط",
  gam_badge_organized_howToGet: "علّم {n} مهمة كمنجزة في المخطط",

  gam_badge_committed: "الملتزم",
  gam_badge_committed_desc: "صفر غيابات غير مبررة لمدة {n}+ أسابيع",
  gam_badge_committed_why: "الحضور الكامل يدل على الالتزام",
  gam_badge_committed_howToGet: "حافظ على صفر غيابات لمدة {n}+ أسابيع",

  gam_badge_outstandingGpa: "معدل متميّز",
  gam_badge_outstandingGpa_desc: "حقق معدل فصلي {n}+",
  gam_badge_outstandingGpa_why: "أداء أكاديمي عالي",
  gam_badge_outstandingGpa_howToGet: "سجّل درجاتك — معدلك يحتاج يوصل {n}+",

  gam_badge_levelUp: "خبير XP",
  gam_badge_levelUp_desc: "اوصل لـ {n} XP",
  gam_badge_levelUp_why: "استخدام منتظم يؤتي ثماره",
  gam_badge_levelUp_howToGet: "اكسب {n} XP — افتح التطبيق وسجّل وادخل الدرجات",

  gam_badge_perfectScore: "الدرجة الكاملة",
  gam_badge_perfectScore_desc: "جب {n} درجات كاملة",
  gam_badge_perfectScore_why: "درجات كاملة محققة!",
  gam_badge_perfectScore_howToGet: "حقق ١٠٠٪ في {n} مكوّنات مقيّمة",
};
