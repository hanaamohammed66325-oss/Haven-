...
export const ar: Record<TranslationKey, string> = {
  ...
  ob_pom_t: "بحيرة التركيز",
  ob_pom_p1: "مؤقّت بومودورو للمذاكرة — كل جلسة تركيز تخلّصها، تطلع لك ورقة نيلوفر جديدة في البحيرة.",
  ...
  tour_pomGrove: "«بستانك» يجمع كل أوراقك حسب المواد — خريطة لكل ما ذاكرته.",
