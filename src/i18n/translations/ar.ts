...
export const ar: Record<TranslationKey, string> = {
  ...
  tour_plannerAddTag: "اضغط الوسم وينحط على الأسبوع المحدّد — نجرّب نضيف واحد.",
  ...
  ob_pom_t: "بومودورو",
  ob_pom_p1: "مؤقّت مذاكرة — كل جلسة تركيز تخلّصها، تطلع لك ورقة نيلوفر جديدة في بحيرتك.",
  ...
  tour_pomPond: "هذي بحيرتك — كل ورقة نيلوفر تطلع أول ما تخلّص جلسة تركيز، وتتلوّن باسم مادتها.",
  ...
  pom_viewDay: "نهار",
  pom_viewNight: "ليل",
  pom_groveCount: "{count} ورقة نيلوفر جمعتها من كل جلسات تركيزك.",
  pom_groveOne: "أول ورقة نيلوفر لك — جلسة تركيز وحدة خلصت.",
  pom_groveEmpty: "خلّص جلسة تركيز وحدة عشان تطلع أول ورقة نيلوفر هنا.",
