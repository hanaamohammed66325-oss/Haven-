export const en = {
  ...
  land_newEyebrow: "New",
  land_newTitle: "Way more than a tracker now.",
  land_newSubtitle: "We just shipped a whole set of features built to keep you motivated — not just organized.",
  ...
  land_pomDesc: "Study with your companion and collect as many lily pads as you can, one focused session at a time. Landing very soon.",
