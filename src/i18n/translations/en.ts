export const en = {
  ...
  pom_lakeLegend: "Each bloom is a subject",
  pom_filterSubject: "Show:",
  pom_allSubjects: "All",
  pom_leafShape: "Leaf shape per subject",
  pom_customizePlant: "Each subject's colour",
  pom_color: "colour",
  pom_viewAuto: "Auto (by clock)",
  pom_viewDay: "Day",
  pom_viewNight: "Night",
  pom_leafClassic: "Classic",
  pom_leafRuffled: "Ruffled",
  pom_leafVictoria: "Victoria",
  pom_leafLotus: "Lotus leaf",
  pom_leafHeart: "Heart",
